//https://starchenkov.pro/create/gulp-pack/

import fs from 'fs';
import fonter from 'gulp-fonter'; //не конвертируется из OTF в TTF
//import fonter from 'gulp-fonter-fix'; //всё равно не сконвертировалось
	...
	fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
		if (fontsFiles) {
			if (!fs.existsSync(fontsFile)) {
				...
				console.log('"src/scss/fonts.scss" уже существует!');
			}
		}
	});
